...
const greetings = [
    ...
    "Chúc qua môn đều đặn",
    "Kì tới được A nhé",
    "Chúc ra trường đúng hạn",
    "Sau đi làm lương nghìn đô",
    "Chúc đi thi trúng tủ"
];
...
const letterText = "Tưởng lại chúc tiếp hả, không có đâu, chúc nhiều trước đó rồi. Phần này thêm vào cho hay thôi. Hehe";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        alert('Trang web để đây là hết, chúc cậu luôn vui vẻ. Tạm biệt!');
